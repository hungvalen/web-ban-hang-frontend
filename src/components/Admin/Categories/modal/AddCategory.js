...
export default function AddCategory({ isShowAddCategoryModal, setIsShowAddCategoryModal }) {
  ...
  return (
    <>
      ...
      <Transition.Root show={isShowAddCategoryModal ?? false} as={Fragment}>
        <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={setIsShowAddCategoryModal ?? false}>
          <Transition.Child
            as={Fragment}
                  ...
                  <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                    <form onSubmit={handleOnSubmit}>
                            ...
                            <div className="flex items-center justify-center flex-wrap gap-2 mt-2">
                              {
                                file != null && (
                                  <div className="overflow-hidden relative">
                                    ...
                                    <img src={URL.createObjectURL(file)} alt="" className="h-56 w-56 object-cover object-center rounded-md" />
                                  </div>
                                )
                              }
                            </div>
                      ...
                      <div className="mt-6 flex items-center justify-end gap-x-6">
                        <button type="button" className="text-sm font-semibold leading-6 text-gray-900" onClick={() => setIsShowAddCategoryModal(false)}
                          ref={cancelButtonRef}>
                          {t('cancel')}
                        </button>
                        <button
