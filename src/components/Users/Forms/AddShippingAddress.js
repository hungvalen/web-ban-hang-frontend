...
const AddShippingAddress = (props) => {
  ...
  return (
    <>
      ...
      <>
        <h2 className="text-lg font-medium text-gray-900">{t('shipping_info')}</h2>
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-1">
              <textarea
                ...
                onChange={onChange}
                className="block w-full rounded-md border-gray-300 border p-2 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              />
            </div>
          </div>
